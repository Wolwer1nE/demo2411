...
ActiveRecord::Schema.define(version: 2020_11_27_120325) do
  ...
  create_table "items_outfits", force: :cascade do |t|
    t.bigint "item_id", null: false
    t.bigint "outfit_id", null: false
    t.index ["item_id"], name: "index_items_outfits_on_item_id"
    t.index ["outfit_id"], name: "index_items_outfits_on_outfit_id"
  end

  create_table "outfit_histories", force: :cascade do |t|
    t.bigint "outfit_id", null: false
    t.bigint "weather_id", null: false
    t.integer "rate"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["outfit_id"], name: "index_outfit_histories_on_outfit_id"
    t.index ["weather_id"], name: "index_outfit_histories_on_weather_id"
  end
